...
from src.db.process_inputs_table_manager import ProcessInputsTableManager, ProcessInputEntry
...
class TestProcessInputsTableManager(unittest.TestCase):
    ...
    @patch("src.db.process_inputs_table_manager.extractProcessInputs")
