...
from src.db.pipeline_params_table_manager import PipelineParamsTableManager, PipelineParamEntry
import pandas as pd
...
class TestPipelineParamsTableManager(unittest.TestCase):
    ...
    @patch("src.db.pipeline_params_table_manager.extractPipelineParameters")
