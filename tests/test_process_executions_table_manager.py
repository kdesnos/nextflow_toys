...
import pandas as pd
from src.db.process_executions_table_manager import ProcessExecutionTableManager, ProcessExecutionEntry
from src.db.nf_trace_db_manager import NextflowTraceDBManager
from src.db.processes_table_manager import ProcessEntry
from src.db.trace_table_manager import TraceEntry
from src.db.resolved_process_names_table_manager import ResolvedProcessEntry
...
class TestProcessExecutionTableManager(unittest.TestCase):
    ...
    @patch("src.db.process_executions_table_manager.extract_trace_data")
    ...
    def test_getExecutionMetricsForProcessAndTraces(self):
        ...
        self.assertEqual(execution_times.iloc[0]["memory"], 768.0)
