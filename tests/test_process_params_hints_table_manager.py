...
from src.db.process_params_hints_table_manager import ProcessParamsHintsTableManager, ProcessParamHintEntry
...
class TestProcessParamsHintsTableManager(unittest.TestCase):
    ...
    @patch("src.db.process_params_hints_table_manager.extract_process_parameters_hints")
