...
from src.db.pipeline_param_values_table_manager import PipelineParamValuesTableManager, PipelineParamValueEntry
from src.db.pipeline_params_table_manager import PipelineParamEntry
...
class TestPipelineParamValuesTableManager(unittest.TestCase):
    ...
    @patch("src.db.pipeline_param_values_table_manager.extractPipelineParameters")
    @patch("src.db.pipeline_param_values_table_manager.extractRunName")
