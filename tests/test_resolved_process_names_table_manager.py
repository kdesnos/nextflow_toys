...
from src.db.resolved_process_names_table_manager import ResolvedProcessNamesTableManager, ResolvedProcessEntry
from src.db.processes_table_manager import ProcessesTableManager, ProcessEntry
...
class TestResolvedProcessNamesTableManager(unittest.TestCase):
    ...
    @patch("src.db.resolved_process_names_table_manager.extractResolvedProcessNames")
